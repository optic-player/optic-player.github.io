...
const i18nDict = {
    en: {
        ...
        version_badge: "Optic Player 0.1.0",
        ...
        telegram_desc: "Join our official channel for lively discussions.",
    ...
    zh: {
        ...
        btn_join_community: "加入社区",
        platforms_title: "无处不在",
        platforms_subtitle: "在您所有喜爱的设备上感受无缝、连续的播放体验。",
        privacy_title: "尊重您的隐私",
        privacy_desc: "Optic Player 绝对不会收集、追踪或共享您的任何个人数据或观影习惯。所有数据仅存在于您的设备和 Emby 服务器之间。",
        community_title: "加入社区",
        community_subtitle: "Optic Player 开发始终由用户驱动。欢迎加入社区，报告错误、提交功能建议、与更多同好交流。",
        telegram_group: "Telegram 群组",
        telegram_desc: "加入官方频道，获取最新动态并参与讨论。",
        github_issues: "GitHub Issues",
